...
public static class DockablePaneExtension
{
    ...
    /// <remarks>
    ///     If <paramref name="dockablePane" /> is null or <see cref="Autodesk.Revit.UI.DockablePane.IsShown" />, nothing
    ///     happen.
    /// </remarks>
    ...
    /// <param name="dockablePane"></param>
    /// <remarks>
    ///     If <paramref name="dockablePane" /> is null or not <see cref="Autodesk.Revit.UI.DockablePane.IsShown" />,
    ///     nothing happen.
    /// </remarks>
    ...
    public static bool TryIsShow(this DockablePane dockablePane)
    {
        if (dockablePane is null)
            return false;
