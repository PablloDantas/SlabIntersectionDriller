...
public class DockablePaneCreatorService : IDisposable
{
    ...
    public DockablePaneCreatorService(UIControlledApplication application)
    {
        ...
        paneIdFrameworkElements = new Dictionary<DockablePaneId, FrameworkElement>();
        dockablePaneDocumentProvider = new Dictionary<DockablePaneId, IDockablePaneDocumentProvider>();
    }
    ...
    /// </summary>
    /// <remarks>
    ///     Unregister the <see cref="UIControlledApplication.DockableFrameVisibilityChanged" /> and
    ///     <see cref="UIControlledApplication.Idling" />.
    /// </remarks>
    public void Dispose()
    {
        if (!HasInitialized)
        ...
        paneIdFrameworkElements.Clear();
        dockablePaneDocumentProvider.Clear();
    }
    ...
    /// </summary>
    /// <remarks>
    ///     Register the <see cref="UIControlledApplication.DockableFrameVisibilityChanged" /> and
    ///     <see cref="UIControlledApplication.Idling" />.
    /// </remarks>
    ...
    private readonly Queue<DockablePaneId> dockablePaneIdsChanged = new();
    ...
    private void ExecutePaneDocumentProviderChanged(UIApplication uiapp, DockablePaneId dockablePaneId)
    {
        ...
        {
            dockablePaneDocumentProvider.TryGetValue(dockablePaneId, out var documentProvider);
    ...
    //
    //     while (dockablePaneIdsChanged.Dequeue() is DockablePaneId dpid) ExecutePaneDocumentProviderChanged(uiapp, dpid);
    // }
    ...
    private bool IsEquals(Document a, Document b)
    {
    ...
    /// <param name="element">The Windows src Framework object containing the pane's user interface.</param>
    /// <remarks>
    ///     By default, is register the <paramref name="element" /> as the intefaces
    ///     <see cref="Autodesk.Revit.UI.IDockablePaneProvider" /> and/or <see cref="IDockablePaneDocumentProvider" />.
    /// </remarks>
    ...
    /// <param name="guid">Unique identifier for the new pane.</param>
    /// <param name="element">The Windows src Framework object containing the pane's user interface.</param>
    /// <param name="dockablePaneProvider">
    ///     Interface that the Revit UI will call during initialization of the user interface to
    ///     gather information about add-in dockable pane windows.
    /// </param>
    /// <remarks>
    ///     By default, is register the <paramref name="element" /> as the intefaces
    ///     <see cref="Autodesk.Revit.UI.IDockablePaneProvider" /> and/or <see cref="IDockablePaneDocumentProvider" />.
    ...
    /// <param name="guid">Unique identifier for the new pane.</param>
    /// <param name="element">The Windows src Framework object containing the pane's user interface.</param>
    /// <param name="dockableDocumentPaneProvider">
    ///     Interface that the Revit UI will call during the idling about add-in
    ///     dockable pane windows.
    /// </param>
    /// <remarks>
    ///     By default, is register the <paramref name="element" /> as the intefaces
    ///     <see cref="Autodesk.Revit.UI.IDockablePaneProvider" /> and/or <see cref="IDockablePaneDocumentProvider" />.
    /// </remarks>
    public bool Register<T>(Guid guid, T element, IDockablePaneDocumentProvider dockableDocumentPaneProvider)
    ...
    ///     <see cref="Autodesk.Revit.UI.IDockablePaneProvider" /> and/or <see cref="IDockablePaneDocumentProvider" />.
    /// </remarks>
    public bool Register<T>(Guid guid, T element, IDockablePaneProvider dockablePaneProvider,
        IDockablePaneDocumentProvider dockableDocumentPaneProvider) where T : FrameworkElement
    {
    ...
    {
        if (paneIdFrameworkElements.TryGetValue(dpid, out var element))
            return element;
