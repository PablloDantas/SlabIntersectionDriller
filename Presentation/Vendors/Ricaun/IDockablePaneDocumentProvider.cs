...
{
    /// <summary>
    ///     This method is called when the DockablePane change state. When the visibility of the DockablePane changed, or a
    ///     document changed inside Revit UI.
    /// </summary>
...
public sealed class DockablePaneDocumentData
{
    ...
    internal DockablePaneDocumentData(DockablePaneId dockablePaneId, FrameworkElement frameworkElement,
        Document document, DockablePane dockablePane)
    {
